 ...
 */
public class DonateBTC extends Activity {
	private static final String DONATION_ADDRESS = "1PZmMahjbfsTy6DsaRyfStzoWTPppWwDnZ"; // prodnet
	// private static final String DONATION_ADDRESS =
	// "mwEacn7pYszzxfgcNaVUzYvzL6ypRJzB6A"; // testnet
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		setContentView(R.layout.donate_btc);

		donateButton = (Button) findViewById(R.id.sample_donate_button);

		donateButton.setOnClickListener(new OnClickListener() {
			public void onClick(final View v) {
				BitcoinIntegration.requestForResult(DonateBTC.this,
						REQUEST_CODE, DONATION_ADDRESS);
			}
		});
